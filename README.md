...
| [Image Management](docs/image-management.md) | Build-once-promote-many lifecycle: build a portable image artefact in one cloud, store it in your storage backend, promote to AWS / Azure / GCP. | You're about to build a custom image and need to know how it'll reach the other clouds. |
