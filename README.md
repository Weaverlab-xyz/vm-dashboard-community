...
| [Cloud Databases](docs/cloud-databases.md) | Provision private Postgres / MySQL / SQL Server (AWS/Azure/GCP) + Oracle (OCI); PRA tunnel; optional Password Safe rotation + Entitle JIT. | You're standing up a managed database and need the per-cloud prerequisites. |
