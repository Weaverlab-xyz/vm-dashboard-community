        ...
        if deploy_job:
            ...
            if meta.get("ot_web_jump_tf_state"):
                ...
                try:
                    ...
                    logger.error("OT web jump removal failed for %s: %s", instance_id, e)
            ...
            if meta.get("ot_tunnel_tf_state"):
                ...
                try:
                    ...
                    logger.error("OT tunnel removal failed for %s: %s", instance_id, e)
            ...
            if meta.get("ot_ps_mirror_tf_state"):
                ...
                if parent_id.isdigit() and sub_id.isdigit():
                    try:
                        ...
                        logger.warning("OT checkout unlink failed for %s: %s", instance_id, e)
                try:
                    ...
                    logger.error("OT checkout mirror removal failed for %s: %s", instance_id, e)
                    result["ot_error"] = (result.get("ot_error", "") +
            ...
            if meta.get("ot_vault_tf_state"):
                ...
                try:
                    ...
                    logger.error("OT vault account removal failed for %s: %s", instance_id, e)
                    result["ot_error"] = (result.get("ot_error", "") +
