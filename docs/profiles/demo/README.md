...
| [Network Demo Cell](net-demo-cell.md) | A VyOS router/firewall with no inbound rule, reached only through a recorded Shell Jump — the emergency rule change, made on a credential nobody sees. |
