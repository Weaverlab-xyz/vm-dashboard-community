...
$cfg = @(
    ...
    "aws_region.${Region}.db_parameter_group_name=$DbParamGroupName",
    "aws_region.${Region}.db_mysql_parameter_group_name=$DbMysqlParamGroupName",
    "aws_region.${Region}.db_security_group_id=$DbSg",
