...
def test_the_pinned_bar_stays_under_the_pages_modal_overlays():
    ...
    overlays are z-40 (rbac/, workload_lab/, functions/, inventory/), so the bar's z-index
...
def test_the_overlays_are_outside_the_nav_a_sticky_bar_would_trap_them_in():
    ...
    z-40` modals in rbac/, workload_lab/, functions/ and inventory/ would paint over an open
    menu."""
    src = _read()
