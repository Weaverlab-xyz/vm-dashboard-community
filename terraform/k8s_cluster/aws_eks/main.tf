...
variable "k8s_version" {
  type        = string
  default     = "1.32"
  description = "Kubernetes minor version for the control plane + node group. Keep on a version with the longest EKS standard support (1.30/1.31 drop to extended support in 2026); bump the default as EKS adds versions."
}
